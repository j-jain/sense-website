/* ══════════════════════════════════════════════════════════════
   proto-setup.js — standalone setup for the Scene-5B preview page.
   A trimmed copy of src/shared/setup.js: registers GSAP + ScrollTrigger
   on window (so the scene's JS keeps using bare globals), boots Lenis,
   and exports the scroll-indicator helpers. Drops the live nav +
   request-a-demo side effects. Self-contained for isolated review.
══════════════════════════════════════════════════════════════ */
