/* ══════════════════════════════════════════════════════════════
   proto-setup.js — standalone setup for the Scene-5C preview page.
   A trimmed copy of src/shared/setup.js: registers GSAP + ScrollTrigger
   on window, boots Lenis, exports scroll-indicator + mobile helpers.
   Drops the live nav + request-a-demo side effects.
══════════════════════════════════════════════════════════════ */
